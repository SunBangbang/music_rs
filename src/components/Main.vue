				...
				<el-aside width="200px">
					...
					>
						...
						<el-menu-item-group>
							...
							<el-menu-item route="/songlist1" index="1-1" style="padding-left: 25px;">歌单1</el-menu-item>
						</el-menu-item-group>
						<el-menu-item-group>
							<template #title></template>
							<el-menu-item route="/songlist2" index="1-2" style="padding-left: 25px;">歌单2</el-menu-item>
						</el-menu-item-group>
						<el-menu-item-group>
							<template #title></template>
							<el-menu-item route="/songlist3" index="1-3" style="padding-left: 25px;">歌单3</el-menu-item>
						</el-menu-item-group>
						</el-submenu>
						<!-- <el-menu-item route="/songlist" index="1">
							<i
								class="iconfont icon-discover"
								style="padding-right: 10px"
							></i>
...
import { ref } from "vue"
// 引入接口
import { _updataPw, _updataUser, _addRecord } from "../utils/api"
	...
	data() {
		return {
			...
			MP3Url: ref(
				...
				'http://121.4.72.17/static/song/2.mp3'
			),
			picUrl: ref(
				// 遇见
