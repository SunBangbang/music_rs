<template>
	<div class="adminvideoContainer">
      <video class="fullscreenVideo" id="bgVid" playsinline="" autoplay="" muted="" loop="">
        <source src="../../assets/video/adminmenu.mp4" type="video/mp4">
      </video>
    </div>
		...
		<el-aside>
			...
			>
				<el-submenu index="1">
					...
					<el-menu-item-group>
						<template #title></template>
						<el-menu-item index="1-2" style="padding-left: 150px;">用户管理</el-menu-item>
					</el-menu-item-group>
					<el-menu-item-group>
						<template #title></template>
						<el-menu-item index="1-3" style="padding-left: 150px;">歌单管理</el-menu-item>
					</el-menu-item-group>
				</el-submenu>
			</el-menu>
		</el-aside>
